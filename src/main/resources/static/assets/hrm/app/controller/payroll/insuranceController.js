app.controller("insuranceController",
    ...
    $scope.salaryListGrid = {
        ...
        columnDefs: [
          ...
          { name: 'InsuranceTitle', displayName:'Insurance Title' },
          { name: 'EmployeeShare', displayName:'Employee Share' },
          { name: 'OrganizationShare', displayName:'OrganizationShare'},
          { name: 'ExpiryDate', displayName:'ExpiryDate'},
          {
