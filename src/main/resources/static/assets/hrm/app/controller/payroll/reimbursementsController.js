app.controller("reimbursementsController",
    ...
    $scope.salaryListGrid = {
        ...
        columnDefs: [
          ...
          { name: 'ReimbursementDate', displayName:'Reimbursement Date' },
          { name: 'SubmittedOn', displayName:'Submitted On' },
          { name: 'Amount', displayName:'Amount' },
          { name: 'ReferenceNo', displayName:'Reference No' },
