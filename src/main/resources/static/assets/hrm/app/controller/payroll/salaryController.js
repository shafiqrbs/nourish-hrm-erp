app.controller("salaryController",
    ...
    $scope.salaryListGrid = {
        ...
        columnDefs: [
          ...
          { name: 'salaryBasicMonthly', displayName:'Basic' },
          { name: 'totalSalaryMonthly', displayName:'Total Salary' },
    ...
    function init(){
        SalaryServices.getAllSalary().then(function(resp){
            $scope.salaryListGrid.data = resp.data.content;
