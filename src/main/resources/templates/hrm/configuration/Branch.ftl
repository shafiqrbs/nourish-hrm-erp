                            ...
                            <div class="row no-margin">
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group">
                                        ...
                                        <input type="text" ng-model="domain.sampleName" class="form-control form-control-sm" id="branchName" placeholder="Branch Name" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="customUi-checkbox checkboxUi-primary  pb-2">
                                        ...
                                        <label for="checked">
                                            ...
                                            <span class="label-helper">Make Branch default</span>
                                        </label>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                    <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                        <div class="flex d-flex flex-column">
                            <h3>All Branchs Information</h3>
                            <span class="portlet-subtitle">All branchs related information</span>
                        </div>
                    </div>
                    <div class="portlet-body no-padding">
                        <div class="row no-margin">
                            <div class="col-lg-12 pt-20 pb-20 no-border-lg-down">
                                <kendo-grid options="BranchInfoDataOptions"></kendo-grid>
                            </div>
                        </div>
                    </div>
                </div>
