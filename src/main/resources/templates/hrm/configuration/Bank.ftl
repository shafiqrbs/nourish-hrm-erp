                            ...
                            <div class="row no-margin">
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group">
                                        ...
                                        <input type="text" ng-model="sMSSettings.bankName" class="form-control form-control-sm" id="bankName" placeholder="Bank Name" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="customUi-checkbox checkboxUi-primary  pb-2">
                                        <input id="checked" type="checkbox" ng-model="bank.isDefault" name="agree" checked="">
                                        <label for="checked">
                                            <span class="label-checkbox"></span>
                                            <span class="label-helper">Make Bank default</span>
                                        </label>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                    <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                        <div class="flex d-flex flex-column">
                            <h3>All Banks Information</h3>
                            <span class="portlet-subtitle">All banks related information</span>
                        </div>
                    </div>
                    <div class="portlet-body no-padding">
                        <div class="row no-margin">
                            <div class="col-lg-12 pt-20 pb-20 no-border-lg-down">
                                <kendo-grid options="BankDataOptions"></kendo-grid>
                            </div>
                        </div>
                    </div>
                </div>
