<div ng-controller="CountryController">
    <div class="rounded shadow-sm p-3 bg-white">
        <div class="row modal-hd" ng-show="IsPopup">
            <div class="col-lg-8 modal-heading">Country Setting</div>
                            ...
                            <div class="row no-margin">
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group">
                                        ...
                                        <input type="text" ng-model="country.name" class="form-control form-control-sm" id="countryName" placeholder="Country Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="sequence" class="control-label">Sequence</label>
                                        <input type="number" ng-model="country.sequenceNo" class="form-control form-control-sm" id="sequence" placeholder="Sequence">
                                    </div>
                                </div>
                                <#--First column end-->
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group">
                                        ...
                                        <input type="text" ng-model="country.displayCode" class="form-control form-control-sm" id="displayCode" placeholder="Display Code">
                                    </div>
                ...
                <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                    <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                        <div class="flex d-flex flex-column">
                            <h3>All Countries Information</h3>
                            <span class="portlet-subtitle">All countries related information</span>
                        </div>
                    </div>
                    <div class="portlet-body no-padding">
                        <div class="row no-margin">
                            <div class="col-lg-12 pt-20 pb-20 no-border-lg-down">
                                <kendo-grid options="CountryInfoDataOptions" height="200"></kendo-grid>
                            </div>
                        </div>
                    </div>
                </div>
