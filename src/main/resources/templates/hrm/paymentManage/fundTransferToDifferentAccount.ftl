<div ng-controller="configurationsController" style="width:100%; height:auto; margin:0;">
    <section class="action-bar">
        <div class="row">
            <div class="col-md-12">
                <!--
                <ul class="action-bar-list list-inline list-unstyled inline">
                    <li>Settings > </li>
                                            ...
                                            <div class="col-md-8">
                                                <div class="box-table">
                                                    <div class="form-group header-action">
                                                        <div class="col-md-10">
                                                            <h1 class="heading">Fund Transfer To Different Account</h1>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-header -->
                                                </div>
