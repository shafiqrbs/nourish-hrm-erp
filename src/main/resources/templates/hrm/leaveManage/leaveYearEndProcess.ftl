<div class="row ng-scope" ng-controller="leaveEndYearProcessController">
                                                    ...
                                                    <div class="row no-margin">
                                                        ...
                                                        <div class="col-lg-3 no-border-lg-down">
                                                            <div class="form-group input-dynamic-add mb-0" style="text-align:right;">
                                                                <input type="text" ng-model="pSearchCriteria" class="form-control form-control-sm ng-pristine ng-untouched ng-valid ng-empty" ng-enter="searchEmployeeInfo(pSearchCriteria)" id="" placeholder="Search criteria type here">
                                                                <a href="javascript:void(0)" class="btn btn-gradient-success btn-icon-o add-new" ng-click="searchEmployeeInfo(pSearchCriteria)">
                                                                    <i class="fa fa-search"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div kendo-grid="" options="EmployeeAllDataOptions" style="height:400px;"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
