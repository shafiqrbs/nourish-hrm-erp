                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                                                <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                                                    <div class="flex d-flex flex-column">
                                                        <h3>Processed Attendance Information</h3>
                                                    </div>
                                                </div>
                                                <div class="portlet-body no-padding">
                                                    <div class="row no-margin">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="" class="control-label text-secondary">Benefit</label>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4 no-border-lg-down">
                                                    <div class="form-group select-dynamic-add">
                                                        <label for="dayStatus" class="control-label">Day status</label><br/>
                                                        <select id="dayStatus" class="form-control form-control-sm" ng-model="employeePQualificationInfo.issuedBy">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-sm" placeholder="OT">
                                                    </div>
                                            ...
                                            <div class="customUi-checkbox checkboxUi-primary  pb-2">
                                                ...
                                                <label for="checked">
                                                    ...
                                                    <span class="label-helper">I checked all system processed data.</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="box-footer clearfix">
                                                <div class="text-right">
                                                    <button type="submit" class="btn btn-gradient-info">Back</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
