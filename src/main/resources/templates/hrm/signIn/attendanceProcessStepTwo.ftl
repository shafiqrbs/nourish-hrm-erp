                                ...
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                                        ...
                                        <div class="form-group input-dynamic-add mb-0 pt-15 pb-15 pl-15 pr-15">
                                            <label for="specificCriteria" class="control-label">Select specific criteria code</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="box-footer clearfix">
                                                <div class="text-right">
                                                    ...
                                                    <button type="button" class="btn btn-gradient-info" ng-click="cancel()">Next</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
