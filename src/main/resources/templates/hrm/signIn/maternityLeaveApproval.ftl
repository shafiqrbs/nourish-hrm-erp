            ...
            <div class="row">
                        ...
                        <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                            <div class="flex d-flex flex-column">
                                <div class="form-group input-dynamic-add mb-0">
                                    <input type="text" ng-model="employeeOfficialInfo.operationCode" class="form-control form-control-sm" id="operationCode" placeholder="Search With Employee Code">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                        <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                            <div class="flex d-flex flex-column">
                                <h3>Maternity Leave Approval</h3>
                            </div>
                        </div>
                    ...
                    <div class="customUi-checkbox checkboxUi-primary  pb-2">
                        ...
                        <label for="checked">
                            ...
                            <span class="label-helper">IsDetail</span>
                        </label>
                    </div>
                </div>
            </div>
