                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for="ShiftIDSpecificCriteriaCode" class="col-sm-4 control-label">Select specific criteria code</label>
                                    <div class="col-sm-8 select-addition">
                                        <select id="ShiftIDSpecificCriteriaCode" class="form-control" required>
                                ...
                                <div class="form-group same-as-check-mark" style="margin-top:10px">
                                    ...
                                    <label class="col-sm-7 control-label">Select All</label>
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="action-btn-add-new">
                                                    <a href="" class="btn btn-info pull-right">Go</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
