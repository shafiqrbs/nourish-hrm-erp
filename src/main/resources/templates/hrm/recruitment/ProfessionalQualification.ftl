<form class="form-horizontal form-general" name="QualificationInfoForm" ng-submit="saveQualificationForm(QualificationInfoForm.$valid,candidatePQualificationInfo)">
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="row no-margin">
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group required">
                                ...
                                <input type="text" class="form-control form-control-sm" id="degreeTitle" placeholder="Certification Title" ng-model="candidatePQualificationInfo.certificationName" required />
                            </div>
                            <div class="form-group">
                                <label for="crtnumber" class="control-label">Certification No.</label>
                                <input type="text" class="form-control form-control-sm" id="crtnumber" placeholder="Certification No." ng-model="candidatePQualificationInfo.certificationNo"/>
                            </div>
                            <div class="form-group required">
                                <label for="courseduration" class="control-label">Course Duration</label>
                                <input type="text" class="form-control form-control-sm" id="courseduration" placeholder="Course Duration" ng-model="candidatePQualificationInfo.courseDuration" required />
                            </div>
                        </div>
                    <#--First column end-->
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group">
                                ...
                                <select id="pcvendor" class="form-control form-control-sm" ng-model="candidatePQualificationInfo.issuedBy">
                                    <option value="">Select Option</option>
                                </select>
                            </div>
                            <div class="form-group select-dynamic-add">
                                <label for="country" class="control-label">Vendor Country</label>
                                <select id="country" class="form-control form-control-sm" ng-model="candidatePQualificationInfo.country">
                                    <option value="">Select Option</option>
                                    <option ng-repeat="option in countries"
                                            ng-selected="candidatePQualificationInfo.country == option.name"
                            ...
                            <div class="form-group date required">
                                ...
                                <input type="date" class="form-control form-control-sm" id="pqCertificationDate" ng-model="candidatePQualificationInfo.certifiedDate" required />
                                <!-- /.input group -->
                            </div>
                        </div>
                        <div class="col-lg-4 pt-20 pb-20 no-border-lg-down">
                            <div class="form-group date">
                                ...
                                <input type="date" class="form-control mt-5 form-control-sm" id="expiryDate" ng-model="candidatePQualificationInfo.expiryDate""/>
                                <!-- /.input group -->
                            </div>
                            <div class="form-group">
                                <label for="crtnotes" class="control-label">Notes</label>
                                <textarea class="form-control form-control-sm" id="crtnotes" placeholder="Notes" rows="3"  ng-model="candidatePQualificationInfo.notes"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
