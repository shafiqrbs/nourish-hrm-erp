<form class="form-horizontal form-general"  name="candidateNomineeInfoForm" ng-submit="saveNomineeForm(candidateNomineeInfoForm.$valid,candidateNomineeInfo)">
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group">
                                ...
                                <div class="employee-photo pull-right">
                                    <img ng-src="{{nomineePP}}" type="{{nomineePP.file.type}}"width="250" height="297" src="http://via.placeholder.com/250x297">
                                    <div class="image-overly btn-group">
                                        <input id="img-file-upload" type="file" accept="image/*"  ng-model-instant onchange ="angular.element(this).scope().imageUpload(event)" style="display: none;"/>
                    ...
                    <#--First column end-->
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group required">
                                ...
                                <input type="text" class="form-control form-control-sm" id="name" placeholder="Name" ng-model="candidateNomineeInfo.name">
                            </div>
                            <div class="form-group">
                                <label for="email" class="control-label">Email</label>
                                <input type="email" class="form-control form-control-sm" id="email" placeholder="Email" ng-model="candidateNomineeInfo.email">
                            </div>
                            <div class="form-group">
                                <label for="phone" class="control-label">Phone</label>
                                <input type="text" class="form-control form-control-sm" id="phone" placeholder="Phone" ng-model="candidateNomineeInfo.phone">
                            </div>
                            <div class="form-group">
                                <label for="relationship" class="control-label">Relationship</label>
                                <select id="relationship" class="form-control form-control-sm" ng-model="candidateNomineeInfo.relationship">
                        ...
                        <div class="col-lg-4 pt-20 pb-20 no-border-lg-down">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="address" placeholder="Address" rows="3" ng-model="candidateNomineeInfo.address"></textarea>
                            </div>
                            <#--<div class="form-group">
