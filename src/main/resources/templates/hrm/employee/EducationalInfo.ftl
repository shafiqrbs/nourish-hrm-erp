<form class="form-horizontal form-general" name="EmpEducationInfoForm" ng-submit="saveEducationForm(EmpEducationInfoForm.$valid,employeeEducationInfo)">
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="row no-margin">
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group required">
                                ...
                                <select id="examName" class="form-control form-control-sm" ng-model="employeeEducationInfo.examName" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="instituteName" placeholder="Institue Name"  ng-model="employeeEducationInfo.instituteName"/>
                            </div>
                            <div class="form-group required">
                                <label for="whichGroup" class="control-label">Major Subject</label>
                                <input type="text" class="form-control form-control-sm" id="whichGroup" placeholder="Major Subject"  ng-model="employeeEducationInfo.whichGroup" required />
                            </div>
                        </div>
                    <#--First column end-->
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="exmrool" placeholder="Examination Roll" ng-model="employeeEducationInfo.examinationRoll" />
                            </div>
                            <div class="form-group">
                                <label for="exmreg" class="control-label">Registration No.</label>
                                <input type="text" class="form-control form-control-sm" id="exmreg" placeholder="Registration No." ng-model="employeeEducationInfo.registrationNo"/>
                            </div>
                            <div class="form-group required">
                                <label for="result" class="control-label">Result / Scrore</label>
                                <input type="text" class="form-control form-control-sm" id="result" placeholder="Result / Scrore" ng-model="employeeEducationInfo.result" required />
                            </div>
                        </div>
                        <div class="col-lg-4 pt-20 pb-20 no-border-lg-down">
                            <div class="form-group select-dynamic-add">
                                <label for="educountry" class="control-label">Country</label>
                                    <select id="educountry" class="form-control form-control-sm" ng-model="employeeEducationInfo.country">
                                        <option value="">Select Option</option>
                                        <option ng-repeat="option in countries" ng-selected="employeeEducationInfo.country == option.name"
                            ...
                            <div class="form-group required">
                                ...
                                <input type="number" class="form-control form-control-sm" id="examYear" placeholder="Passing Year"  ng-model="employeeEducationInfo.examYear" required />
                            </div>
                        </div>
                    </div>
                </div>
