<form class="form-horizontal form-general" name="EmpLanguageForm" ng-submit="saveLanguageForm(EmpLanguageForm.$valid,employeeLanguage)">
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="row no-margin">
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group required">
                                ...
                                <select id="languageName" class="form-control form-control-sm" ng-model="employeeLanguage.languageName" required>
                            ...
                            <div class="form-group required">
                                ...
                                <select id="writing" class="form-control form-control-sm" ng-model="employeeLanguage.writing" required>
                    ...
                    <#--First column end-->
                        <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                            <div class="form-group required">
                                ...
                                <select id="reading" class="form-control form-control-sm" ng-model="employeeLanguage.reading" required>
                            ...
                            <div class="form-group required">
                                ...
                                <select id="spoken" class="form-control form-control-sm" ng-model="employeeLanguage.spoken" required>
                        ...
                        <div class="col-lg-4 pt-20 pb-20 no-border-lg-down">
                            <div class="form-group required">
                                ...
                                <select id="emlangugelistening" class="form-control form-control-sm" ng-model="employeeLanguage.listening" required>
                            ...
                            <div class="d-block" hook="same-as-present">
                                <div class="customUi-checkbox checkboxUi-primary pb-2">
                                    <input id="chk6" type="checkbox" name="motherLanguage"  ng-model="employeeLanguage.motherLanguage">
                                    <label for="chk6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="languagenote" placeholder="Notes" ng-model="employeeLanguage.notes"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
