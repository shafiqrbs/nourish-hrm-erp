<div ng-controller="disciplinaryActionManageController">
    <div class="rounded shadow-sm p-3 bg-white">
        <form class="form-horizontal form-general" name="EmpDisciplinaryActions" ng-submit="saveForm(EmpDisciplinaryActions.$valid,disciplinaryAction)">
            <div class="row">
                            ...
                            <div class="flex d-flex flex-column">
                                <div class="form-group input-dynamic-add mb-0">
                                    <input type="text" ng-model="pSearchCriteria"
                                           ...
                                           placeholder="Search With Employee Code" autocomplete="off" />
                    ...
                    <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                        ...
                        <div class="portlet-body no-padding">
                            <div class="row no-margin">
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group">
                                        <label for="disciplinaryActionType" class="control-label">Disciplinary Action Type</label>
                                        <select id="disciplinaryActionType" class="form-control form-control-sm" ng-model="disciplinaryAction.disciplinaryActionType" required>
                                            <option value="">Select Option</option>
                                            <option value="Action 1">Action 1</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="disciplinaryActionDescription" class="control-label">Description</label>
                                        <input type="text" ng-model="disciplinaryAction.description" class="form-control form-control-sm" id="disciplinaryActionDescription" placeholder="Description">
                                    </div>
                                </div>
                                <#--First column end-->
                                <div class="col-lg-4 b-r pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group date">
                                        <label for="disciplinaryActionEffectiveDate" class="control-label">Effective Date</label>
                                        <input id="effectiveDate" ng-model="disciplinaryAction.effectiveDate" type="date" placeholder="YYYY-MM-DD" class="form-control form-control-sm" autocomplete="off" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="disciplinaryActionAction" class="control-label">Action</label>
                                        <input type="text"  ng-model="disciplinaryAction.disAction" class="form-control form-control-sm" id="disciplinaryActionAction" required>
                                    </div>
                                </div>
                                <#--Second column end-->
                                <div class="col-lg-4 pt-20 pb-20 no-border-lg-down">
                                    <div class="form-group date">
                                        <label for="disciplinaryActionDismissDate" class="control-label">Action Dismiss Date</label>
                                        <input id="activationDate" type="date" ng-model="disciplinaryAction.activationDate" placeholder="YYYY-MM-DD" class="form-control form-control-sm" autocomplete="off">
                                    </div>
                                    <div class=" customUi-checkbox checkboxUi-primary">
                                        <input type="checkbox" ng-model="disciplinaryAction.effected" id="c-checkboxcharman" />
                                        <label for="c-checkboxcharman">
                                            <span class="label-checkbox"></span>
                                            <span class="label-helper">Is Effect In Salary</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                    <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                        <div class="flex d-flex flex-column">
                            <h3>Disciplinary Action Information</h3>
                            <span class="portlet-subtitle">All Disciplinary Action Information Record For Specific Employee</span>
                        </div>
                    </div>
                    <div class="portlet-body no-padding">
                        <div class="row no-margin">
                            <div class="col-lg-12 pt-20 pb-20 no-border-lg-down">
                                <kendo-grid options="EmployeeDisciplinaryActonDataOptions" style="height:200px;"></kendo-grid>
                            </div>
                        </div>
                    </div>
                </div>
