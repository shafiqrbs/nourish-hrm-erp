            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-header-action">
                        <h3 class="heading">Utility Information</h3>
                    </div>
                </div>
            </div>
                    ...
                    <form class="form-horizontal form-general" name="CompanySettingForm" ng-submit="saveForm(CompanySettingForm.$valid,companySettings)">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="publicationTitle" class="col-sm-4 control-label">Utility Title</label>
                                        <div class="col-sm-8">
                                            <input type="text"  class="form-control" id="publicationTitle" placeholder="Publication Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="publicationTitle" class="col-sm-4 control-label">Description</label>
                                        <div class="col-sm-8">
                                            <input type="text"  class="form-control" id="publicationTitle" placeholder="Publication Title">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="publicationMedia" class="col-sm-4 control-label">Celling Value</label>
                                        <div class="col-sm-8">
                                            <input type="text"  class="form-control" id="publicationMedia" placeholder="Publication Media">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="copyRight" class="col-sm-4 control-label">Actual Bill</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="financedBy" class="col-sm-4 control-label">Deductible Amount</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-md-12">
                                    <div class="box-table">
                                        ...
                                        <div class="box-table-wrap">
                                            <kendo-grid options="employeeUtilityInformationGridOptions"></kendo-grid>
                                        </div>
                                    </div>
                                </div>
                            </div>
